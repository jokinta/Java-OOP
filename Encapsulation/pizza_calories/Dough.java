...
public class Dough {
    ...
    private static final String INVALID_TYPE_DOUGH_EXCEPTION_MESSAGE = "Invalid tyoe of dough.";
    ...
    public Dough(String flourType, String backingTechnique, double weight) {
        ...
        this.setBackingTechniques(backingTechnique);
    ...
    private void setBackingTechniques(String backingTechnique) {
